...
const config = {
  ...
  ios: {
    ...
    // Documentation parity with ios/SplitCircle/SplitCircle.entitlements (doc 27) —
    // this repo's ios/ is hand-maintained, not regenerated by `expo prebuild`, so
    // the entitlements file is what actually takes effect; this flag matters only
    // if this project ever goes back through prebuild.
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription: 'ManaSplit uses your local network to exchange messages with nearby group members when the internet is unavailable.',

...
The end-to-end product path is implemented in code and validated with direct unit, service, DOM, Functions, and Firestore-emulator tests. .  Describe commercial dark-web monitoring, scheduled scans, or device alerts as live production capabilities.

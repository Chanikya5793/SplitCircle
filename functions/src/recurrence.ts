...
export const normalizeRecurrenceRule = (
    ...
    const timezoneOffsetMinutes = typeof rule?.timezoneOffsetMinutes === "number" && Number.isFinite(rule.timezoneOffsetMinutes)
...
export const toLegacyRecurrenceRule = (
    frequency: LegacyBillFrequency | undefined,

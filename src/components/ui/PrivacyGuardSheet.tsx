 ...
 * Rows keep their own dividers in BOTH modes — that hairline is what carries
 * the grouping once the card's box is gone. (Briefly suppressed in flat mode
 * on 2026-08-07 under a "zero dividers anywhere" direction; reversed the same
 * day. Don't remove them again.)
 */
